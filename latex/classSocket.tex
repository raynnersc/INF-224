...
Connects the socket to an address. Typically used for connecting T\+C\+P/\+IP clients to a \mbox{\hyperlink{classServerSocket}{Server\+Socket}}. On Unix/\+Linux host can be a hostname, on Windows it can only be an IP address. \begin{DoxyReturn}{Returns}
...
Receives data from a connected (T\+C\+P/\+IP) socket. Reads at most {\itshape len} bytes fand stores them in {\itshape buf}. By default, this function blocks the caller until thre is availbale data. \begin{DoxyReturn}{Returns}
...
Send sdata to a connected (T\+C\+P/\+IP) socket. Sends the first {\itshape len} bytes in {\itshape buf}. \begin{DoxyReturn}{Returns}
